...
python -u finetune.py --save_name GECCOW100P5MaskR320Finetune --data NIPS_TS_GECCO --win_size 100 --patch_len 5 --mask_mode binomial --repr_dims 320 --ptm /workspace/ptm_anomaly_detection/training1/W100P5MaskR320-20231012/model.pkl --ratio 1 --finetune 1 --eval
